...
<div ng-cloak>
    <style>
        ...
        /* badge màu xanh cho category */
        .badge-category {
            background-color: #007bff;
            color: #fff;
        }

        /* badge màu xanh lá cho collection */
        .badge-collection {
            background-color: #28a745;
            color: #fff;
        }

        /* nếu muốn highlight toàn bộ box khác nhau */
        .type-category .dd3-content {
            border-left: 4px solid #007bff;
        }
        .type-collection .dd3-content {
            border-left: 4px solid #28a745;
        }

        /* giữ transition cho đẹp mắt */
        .dd3-content {
...
//                  }
    ...
    foreach($items as $value) {
        // chọn màu badge theo type
        $badgeClass = $value['type'] === 'collection'
            ? 'badge-collection'
            : 'badge-category';
        $badgeText = ucfirst($value['type']); // “Category” hoặc “Collection”

        // thêm class type-... vào <li>
        $html .= '<li class="dd-item dd3-item type-'. $value['type'] .'" data-id="'. $value['id'] .'">';
        $html .= '  <div class="dd-handle dd3-handle"></div>';
        $html .= '  <div class="dd3-content">';
        $html .= '    <span class="item-label">'. htmlspecialchars($value['name']) .'</span>';
        // in badge kế bên tên
        $html .= '    <span class="item-badge '. $badgeClass .'">'. $badgeText .'</span>';
        $html .= '    <span class="span-right">';
        $html .= '      <a class="edit-button" href="'. route('Category.edit',$value['id']) .'"><i class="fas fa-pencil-alt"></i></a>';
        $html .= '      <a class="del-button confirm" href="'. route('Category.delete',$value['id']) .'"><i class="fa fa-trash"></i></a>';
        $html .= '    </span>';
        $html .= '  </div>';
