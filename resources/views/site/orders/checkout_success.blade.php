                                ...
                                <tr class="product">
                                    ...
                                    <div class="product-thumbnail">
                                        <div class="product-thumbnail-wrapper">
                                            ...
                                            ?>
                                            <img class="product-thumbnail-image" alt="{{$variant->baseProduct->name}}"
                                    ...
                                    <span class="product-description-name order-summary-emphasis">{{$variant->baseProduct->name}}</span>
