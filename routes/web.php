...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'abouts'], function () {
        Route::get('/{id}/edit', 'Admin\AboutController@edit')->name('abouts.edit');
    ...
    Route::group(['prefix' => 'categories'], function() {
        ...
        Route::get('/{id}/getCollectionByCateId', 'Admin\CategoryController@getCollectionByCateId')->name('Category.getCollectionByCateId');
        Route::get('/{id}/getCategoriesSpecialByCateId', 'Admin\CategoryController@getCategoriesSpecialByCateId')->name('Category.getCategoriesSpecialByCateId');
    ...
    Route::group(['prefix' => 'product-variants'], function () {
        ...
        Route::get('/act-delete', 'Admin\ProductVariantController@actDelete')->name('products.delete.multi');
        Route::post('/{id}/deleteFile', 'Admin\ProductVariantController@deleteFile')->name('products.deleteFile');
    });

    Route::group(['prefix' => 'colors'], function () {
        Route::get('/', 'Admin\ColorController@index')->name('colors.index');
        Route::get('/create', 'Admin\ColorController@create')->name('colors.create');
        Route::post('/', 'Admin\ColorController@store')->name('colors.store');
        Route::post('/{id}/update', 'Admin\ColorController@update')->name('colors.update');
        Route::get('/{id}/edit', 'Admin\ColorController@edit')->name('colors.edit');
        Route::get('/{id}/delete', 'Admin\ColorController@delete')->name('colors.delete');
        Route::get('/searchData', 'Admin\ColorController@searchData')->name('colors.searchData');
        Route::get('/{id}/getData', 'Admin\ColorController@getData')->name('colors.getData');
    });

    Route::group(['prefix' => 'sizes'], function () {
        Route::get('/', 'Admin\SizeController@index')->name('sizes.index');
        Route::get('/create', 'Admin\SizeController@create')->name('sizes.create');
        Route::post('/', 'Admin\SizeController@store')->name('sizes.store');
        Route::post('/{id}/update', 'Admin\SizeController@update')->name('sizes.update');
        Route::get('/{id}/getDataForEdit', 'Admin\SizeController@getDataForEdit')->name('sizes.get.data.edit');
        Route::get('/{id}/edit', 'Admin\SizeController@edit')->name('sizes.edit');
        Route::get('/{id}/delete', 'Admin\SizeController@delete')->name('sizes.delete');
        Route::get('/searchData', 'Admin\SizeController@searchData')->name('sizes.searchData');
        Route::get('/{id}/getData', 'Admin\SizeController@getData')->name('sizes.getData');
    });
    ...
    Route::group(['prefix' => 'orders'], function () {
        ...
        Route::get('/{order}/track', 'Admin\OrderController@showTrackForm')->name('orders.track.form');
        Route::post('/{order}/track', 'Admin\OrderController@track')->name('orders.track');
    });
