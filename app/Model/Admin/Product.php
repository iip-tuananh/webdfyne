...
class Product extends BaseModel
{
    ...
    public static function getDataForEdit($id)
    {
        ...
        $product->size_ids = $product->sizes->pluck('id')->toArray();
        $product->collections_ids = $product->collections->pluck('id')->toArray();
        $product->categories_special_ids = $product->category_specials->pluck('id')->toArray();
