...
class Category extends BaseModel
{
    ...
    public function categoriesSpecial() {
        return $this->hasMany(CategorySpecial::class,'category_parent_id');
    }

    public function collections() {
        return $this->hasMany(Category::class,'parent_id')->where('type', 'collection');
    }
    ...
    {
        return $this->belongsToMany(Product::class, ProductCollection::class, 'category_id', 'product_id');
    }
...
//    }
    ...
    public static function getForSelect($type = 'category')
    {
