...
//			$object->link = $request->link;
    ...
    public function getCollectionByCateId($cateId) {
        $category = Category::query()->find($cateId);
        ...
        $collections = Category::query()->where('type', 'collection')->where('parent_id', $parent_id)->get();
        $json = new stdclass();
        $json->success = true;
    ...
    public function getCategoriesSpecialByCateId($cateId) {
        $category = Category::query()->find($cateId);
        ...
        $data = CategorySpecial::query()->where('category_parent_id', $parent_id)->get();
        $json = new stdclass();
        $json->success = true;
        $json->data = $data;
